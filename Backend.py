    ...
    def add_lawyer(self, lawyer_name, lawyer_email, lawyer_phone, lawyer_password, registered_time, country, city, profile_pic, area_of_practice):
        try:
            ...
            if verification == "True":
                query = "INSERT INTO lawyers (NAME, EMAIL, NUMBER, PASSWORD, REGISTERED_AT,COUNTRY,CITY,PROFILE_PIC,AREA_OF_PRACTICE,ODERS_COMPLETED)  VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
